...
class MovieModelImpl extends MovieModel {
  ...
  Future<List<MovieVO>> getNowPlayingMoviesFromDatabase() {
    return Future.value(
      mMovieDao.getAllMovieList().where((movie) => movie.isNowPlaying).toList(),
    );
  }
  ...
  Future<List<MovieVO>> getPopularMoviesFromDatabase() {
    return Future.value(
      mMovieDao.getAllMovieList().where((movie) => movie.isPopular).toList(),
    );
  }
  ...
  Future<List<MovieVO>> getTopRatedMoviesFromDatabase() {
    return Future.value(
      mMovieDao.getAllMovieList().where((movie) => movie.isTopRated).toList(),
    );
  }
